					...
					<div class="recom-plugin-wrap">
						...
						<div class="plugin-title-install clearfix">
							<div class="version-author-info">
								<span class="version"><?php echo esc_html__('Version ', 'xews-lite') . esc_html($plugin['version']); ?></span>
		...
		foreach($this->free_plugins as $plugin) {
			...
			?>
				<div class="recom-plugin-wrap">
					...
					<div class="plugin-title-install clearfix">
						<div class="version-author-info">
							<span class="version"><?php echo esc_html__('Version ', 'xews-lite') . esc_html($info->version); ?></span>
							<span class="seperator">|</span>
